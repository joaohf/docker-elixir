defmodule CreateContainerConfigTest do
  ...
  test "defined hostname is untouched" do
    ...
    conf =
      %Docker.Config{generic_hostname: false, hostname: hostname}
  ...
  test "volume formatting" do
    conf =
      %Docker.Config{volumes: %{"/opt/container" => "/data"}} |> Docker.Config.create_container()
...
defmodule StartContainerConfigTest do
  ...
  test "bound volume formatting" do
    conf =
      %Docker.Config{volumes: %{"/opt/container" => "/data"}} |> Docker.Config.start_container()
